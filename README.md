...
sudo cp /etc/letsencrypt/live/yourdomain.com/fullchain.pem /etc/pantos/pantos-service-node-fullchain.pem
sudo cp /etc/letsencrypt/live/yourdomain.com/privkey.pem /etc/pantos/pantos-service-node-privkey.pem
```
...
PANTOS_CERT_PATH="/etc/pantos/pantos-service-node-fullchain.pem"
PANTOS_KEY_PATH="/etc/pantos/pantos-service-node-privkey.pem"
...
```
sudo mv ~/.ethereum/keystore/UTC--<timestamp>--<your-address> /etc/pantos/keystore/pantos-service-node.keystore
